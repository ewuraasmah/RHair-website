			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
						<li class=" active"><a href="index.html" class="hyper "><span>Go Back</span></a></li>	
						</li>
	...
	<div class="login">
		...
		<div class="footer">
			<div class="container">
				...
				<a href="index.html"><img src="images/logo.jpg" alt=" " /><h3>R Hair<span></span></h3></a>
				<ul>
					<li>Spintex Road</li>
					<li>Accra, Ghana</li>
				...
				<div class="clearfix"></div>
				<p class="copy-right">© 2020 RHair . All rights reserved</a></p>
			</div>
		</div>	 
</body>
</html>